...
def main():
    ...
    cta_sub = "Visit https://tradelift.surge.sh for apprenticeships, certifications, and step-by-step guides."
    c.setFont("DejaVu", 16)
    c.setFillColor(TEXT_MUTED)
    ...
    # Copyright
    copyright_text = "© 2025 TradeLift. All rights reserved. | https://tradelift.surge.sh"
    c.setFont("DejaVu", 12)
    c.setFillColor(TEXT_MUTED)
